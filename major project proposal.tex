...
\makebox[9cm]{Amit Dhoju \hfill [44084]}\\
\makebox[9cm]{Kaushtup Bista \hfill [44096]}\\
\makebox[9cm]{Roshi Maharajan \hfill [44108]}
...
\newcommand{\defDay}{16} %specify Defense Day- 1, 2, ...
...
\newcommand{\degSup}{Founder and CEO}
\newcommand{\orgSUP}{Quantasoft Technology \& Research Centre} %Specify Designation of Supervisor for Major Project, use multiple lines (\\) if necessary
\newcommand{\external}{Dr. Dibakar Raj Pant } %Specify Name of External for Major Project (Required for Black Book)
\newcommand{\degExternal}{Assistant Professor}
\newcommand{\orgExt}{Pulchowk Campus, IOE} %Specify Name of External for Major Project (Required for Black Book) , use multiple lines (\\) if necessary
...
\subsection{Data Collection in Company}
...
\begin{center}
	...
	\caption{landing Page} %figure name
	\label{Homepage} % for referencing
\end{center}
\end{figure}
...
\begin{center}
	...
	\caption{System Output} %figure name
	\label{Scr} % for referencing
\end{center}
\end{figure}
...
\begin{center}
	...
	\caption{Crystal Report} %figure name
	\label{Crystal Report} % for referencing
\end{center}
\end{figure}
...
\begin{center}
	...
	\caption{Bar Diagram}  %figure name
	\label{Output Preview} % for referencing
\end{center}
\end{figure}
\newpage
\begin{figure}[tbh] % tbh means top, bottom or here (priority: left to right)
\begin{center}
	...
	\caption{Confusion matrix}  %figure name
	\label{Tesing Output Confusion Matrix} % for referencing
\end{center}
\end{figure}
